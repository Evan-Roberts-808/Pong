import pygame
from assets.two_player import main_2_player
from assets.one_player import main_1_player
import neat
import os
import pickle
...
config_path = os.path.join(assets_dir, "config.txt")
pickle_path = os.path.join(assets_dir, "best.pickle")
